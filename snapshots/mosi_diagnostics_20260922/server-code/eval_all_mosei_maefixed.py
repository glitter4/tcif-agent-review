...
def main():
    ...
    parser.add_argument(
        "--checkpoints_root",
        type=str,
        default="/path/to/user/m4oe/StructV7.0/train/checkpoints",
    )
    parser.add_argument(
        "--results_root",
        type=str,
        default="/path/to/user/m4oe/StructV7.0/eval_all_mosei_maefixed",
    )
    parser.add_argument(
        "--default_dataset",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="/path/to/user/models/google-bert_bert-base-uncased",
    )
    parser.add_argument(
        "--default_vit_path",
        type=str,
        default="/path/to/user/models/vit-base-patch16-224-in21k",
    )
    parser.add_argument(
        "--default_bert_path",
        type=str,
    ...
    parser.add_argument(
        "--default_hubert_path",
        type=str,
        default="/path/to/user/models/hubert-base-ls960",
    )
    parser.add_argument(
        "--default_vision_backbone_path",
        type=str,
        default="/path/to/user/models/resnet-18",
    )
